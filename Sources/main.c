...
static void init_gpio(void) {
    ...
    LL_GPIO_SetPinSpeed(GPIOA, GPIO_PIN_2, LL_GPIO_SPEED_HIGH);
    LL_GPIO_SetAFPin_0_7(GPIOA, GPIO_PIN_2, GPIO_AF4_USART2);
    LL_GPIO_SetPinPull(GPIOA, GPIO_PIN_2, LL_GPIO_PULL_NO);

    // uart2 rx
    LL_GPIO_SetPinMode(GPIOA, GPIO_PIN_3, LL_GPIO_MODE_ALTERNATE);
    LL_GPIO_SetPinSpeed(GPIOA, GPIO_PIN_3, LL_GPIO_SPEED_HIGH);
    ...
    LL_GPIO_SetPinSpeed(GPIOA, GPIO_PIN_5, LL_GPIO_SPEED_LOW);
