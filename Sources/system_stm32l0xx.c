...
/* printf redirect */
int __io_putchar(int ch) { // declaration in syscalls.c
 ...
 * Values. The SystemCoreClock variable contains the core clock (HCLK), it
 * can be used by the user application to setup the SysTick timer or
 ...
 *
 *         (*) HSI_VALUE is a constant defined in stm32l0xx_hal.h file
 ...
 * (default value 8 MHz), user has to ensure that HSE_VALUE is same as the
 * real frequency of the crystal used. Otherwise, this function may have
 * wrong result.
 *
